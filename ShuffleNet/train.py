...
from model import shufflenet_v2_x0_5, shufflenet_v2_x1_0, shufflenet_v2_x1_5, shufflenet_v2_x2_0
import pandas as pd
import time
...
# number of parameter
with open("shufflenet_v2_x0_5.txt", "r") as f:
    for line in f:
