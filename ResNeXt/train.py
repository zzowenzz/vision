...
from model import resnext50_2x40d, resnext50_4x24d, resnext50_8x14d, resnext50_32x4d, resnext101_2x40d, resnext101_4x24d, resnext101_8x14d, resnext101_32x8d
import pandas as pd
import time
...
# number of parameter
with open("resnext101_32x8d.txt", "r") as f:
    for line in f:
